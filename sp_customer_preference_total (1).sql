/****** Object:  StoredProcedure [consumption].[sp_customer_preference_total]    Script Date: 2/7/2023 12:52:00 PM ******/
SET ANSI_NULLS ON
GO
...
sum(case when page_grouping is not NULl then n_clicks end ) as n_clicks,
...
min(visit_date) as visit_date from consumption.customer_preference_temp
